...
export default function Home() {
 return (
  <div className=" flex justify-center items-center h-full" style={{height: '100vh'}}>
    <Image className=" absolute z-0 h-full w-full" src="https://burbanostudio-assets.s3.us-east-2.amazonaws.com/projects/tenistide/bg-tt.png" alt="bg" fill/>
    <figure className="c z-10 bg-white p-20 shadow-lg rounded-lg">
      <Image src="https://burbanostudio-assets.s3.us-east-2.amazonaws.com/projects/tenistide/tt-blue.png" style={{filter: 'drop-shadow(4px 4px 0px #ffff00)'}}  alt="logo" className='w-40 block mb-6' width="160" height="160" />
